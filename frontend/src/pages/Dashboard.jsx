...
//     <div>
//       <h2>Dashboard</h2>
//       <p><strong>Balance:</strong> {balance != null ? `$${(balance/100).toFixed(2)}` : 'N/A'}</p>
...
//         {bids.map(b => (
//           <li key={b.id}>
//             {b.direction} {b.amount_cents}c — {b.status} — 
//             entry {b.entryPrice} — settleAt {new Date(b.settleAt).toLocaleTimeString()}
//           </li>
//         ))}
//       </ul>
//     </div>
