...
//       setMsg('Placed: ' + JSON.stringify(r.data));
//     } catch (e) {
...
//     <div>
//       <h2>Place Bid</h2>
//       <label>Amount (cents): <input value={amount} onChange={e=>setAmount(Number(e.target.value))} /></label>
//       <div>
//         <button onClick={()=>setDirection('UP')} style={{fontWeight: direction==='UP'?'bold':'normal'}}>UP</button>
//         <button onClick={()=>setDirection('DOWN')} style={{fontWeight: direction==='DOWN'?'bold':'normal'}}>DOWN</button>
//       </div>
...
//       // We call backend to lock entry price (simulate preview)
//       const idempotencyKey = cryptoRandom();
//       const r = await placeBid(token, amount, direction, idempotencyKey);
//       // Show confirm modal with returned bid info
//       setConfirmData({
//         bidId: r.data.bidId,
...
//       setMsg('Bid placed! ' + JSON.stringify(r.data));
//       setConfirmData(null);
//     } catch (e) {
